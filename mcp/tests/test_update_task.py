...
def test_update_task_title(test_session, test_user_id):
...
def test_update_task_description(test_session, test_user_id):
...
def test_update_task_completed_status(test_session, test_user_id):
...
def test_update_task_multiple_fields(test_session, test_user_id):
...
def test_update_task_not_found(test_session, test_user_id):
    """Test updating a non-existent task."""
    with patch('src.tools.update_task.get_session') as mock_update_session:
        mock_update_session.return_value = test_session
...
def test_update_task_unauthorized(test_session):
...
def test_update_task_title_too_long(test_session, test_user_id):
