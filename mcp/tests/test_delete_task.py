...
def test_delete_task_success(test_session, test_user_id):
...
def test_delete_task_verifies_deletion(test_session, test_user_id):
...
def test_delete_task_not_found(test_session, test_user_id):
    """Test deleting a non-existent task."""
    with patch('src.tools.delete_task.get_session') as mock_delete_session:
        mock_delete_session.return_value = test_session
...
def test_delete_task_unauthorized(test_session):
...
def test_delete_task_twice(test_session, test_user_id):
